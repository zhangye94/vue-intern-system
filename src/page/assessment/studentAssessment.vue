<template>
  <div id="student-assessment-model">
    <div class="content">
      <div class="content-title">
        <h2>学生考核列表</h2>
        <router-link to="/studentAssessment/assssmentAdd" class="add" v-if="root == 10002||root == 10003"><i class="el-icon-plus"></i></router-link>
...
<script>
  export default {
    ...
    created: function () {
      this.getTableData();
      this.$store.state.adminleftnavnum="/assessment/studentAssessment";
    },
    data () {
      return {
        dialogVisible: false,
